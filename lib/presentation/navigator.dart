...
import 'package:my_tasks/presentation/home_page.dart';
...
class RouterNotifier extends ChangeNotifier {
  RouterNotifier() {
    //Subcribe to event of user auth or not, and notify changes with  notifyListeners();
  }
  ...
  List<GoRoute> get _routes => [
        GoRoute(
          ...
          routes: [
            ...
            GoRoute(path: 'settings', name: SettingsPage.pageName, pageBuilder: (context, _) => fadeTransition(const SettingsPage(), _)),
          ],
        ),
      ];
}
